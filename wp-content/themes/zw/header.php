...
<div id="page" class="hfeed">
	<header id="branding" class="branding" role="banner">
			...
			<h1 id="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">Z&W</a></h1>
<!--<img src="<?php // echo get_template_directory_uri();?>/images/logo.png" alt="logo" title="<?php // bloginfo( 'name' ); ?>"  />-->
			...
			<nav id="access" class="primary-nav" role="navigation">
				<?php get_search_form(); ?>
				<?php wp_nav_menu( array( 'theme_location' => 'primary' ) ); ?>
	<div class="clear"></div>
			</nav><!-- #access -->
<div class="banner0">
  <img src="<?php echo get_template_directory_uri(); ?>/images/banner/banner1.jpg" alt="" width="1000" />
</div>
	</header><!-- #branding -->
